...
|            000 |           011 | In the map press the "Mine/Gold" Button. | The bottom zero at the top should increment up. | The bottom zero does increment up. | Pass |
|            000 |           011 | In the map press the "Mine/Gol" Button again. | The bottom zero should increment up again. | The bottom zero does increment up again. | Pass |
